...
const Stock_Inventory = ({ ToggleAlert }) => {
  ...
  const filterdata = (val) => {
    if (customer && search != "") {
      return val.stock_inventory_name.toLowerCase().includes(search);
    }
      ...
      return val.stock_inventory == qoutation_value;
    } else {
      return val;
    }
  }
  ...
  const show = (value) => {
    axios.get(`${process.env.REACT_APP_API_URL}/inventory/stock_inventory/getStock_inventoryPage?page=${value}&id=${user_id}`, {
      'user_id': user_id
    }).then((response) => {
    ...
    axios.get(`${process.env.REACT_APP_API_URL}/inventory/stock_inventory?id=${user_id}`, {
      'user_id': user_id
    }).then((response) => {
            ...
            <div className="px-md-4 pt-md-4 px-2 pt-2">
              <div className="d-flex justify-content-between flex-row my-2 border-bottom py-3">
                ...
                <div className="d-flex justify-content-end flex-md-row flex-column">
                  <Link to="/inventory/add_stock_inventory" className="text-center">
                    <button
                ...
                <div className="d-flex justify-content-end flex-md-row flex-column">
                  ...
                  <div className="text-center mx-md-2 my-2 my-md-0">
                    <ReactHTMLTableToExcel
                      id="inventory-table-xls-button"
                      className="btn btn-md btn-primary p-2 p-md-3 btn_radius"
                      table="inventory-table-to-xls"
                ...
                <div className="col-sm-4 mb-6">
                  ...
                  <div className="input-group">
                    ...
                    <input
                      ...
                      className="form-control"
                      placeholder="Enter stock inventory ID"
                    ...
                    data
                      ...
                      .map((val, index) => (
                        ...
                        />
                            ...
                            <td>SI-{val.stock_inventory}</td>
                            <td>{val.stock_inventory_name}</td>
                            <td>{val.sku}</td>
                            <td>{val.WareHouse.stock_warehouse_name}</td>
                            <td>{val.quantity}</td>
                            <td>PKR {val.price.toLocaleString()}</td>
                            <td>
                              PKR {(val.price * val.quantity).toLocaleString()}
                            </td>
                            <td>{val.date}</td>
                            {/* <td>
...
export default Stock_Inventory;
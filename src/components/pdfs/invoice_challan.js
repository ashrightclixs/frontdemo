...
function InvoiceChallan({ user, ToggleAlert }) {
  // delivery_challan;
  ...
  const fetchData = async () => {
    ...
    await axios
      .get(
        `${process.env.REACT_APP_API_URL}/sales/invoice/invoice_challan?id=${params.id}`
      )
      .then((response) => {
          ...
          <View style={styles.FlexSection}>
            ...
            <View>
              <Text
                style={[
                  styles.headingFont,
                  { fontFamily: "Lato Bold", marginLeft: "auto" },
                ]}
              >
                Invoice
              </Text>
              ...
              >
                {`PKR ${(
                  data.invoice.net - data.invoice.received
                ).toLocaleString()}.00`}
              </Text>
            </View>
          </View>
            ...
            <View>
              <View style={styles.table}>
                <View style={styles.tableRow}>
                  <View style={[styles.tableColGLeft, { textAlign: "right" }]}>
                    <Text style={styles.tableCell}>Invoice Date :</Text>
                  </View>
                  <View style={styles.tableColGRight}>
                    <Text style={[styles.tableCell, { textAlign: "right" }]}>
                      {data.invoice.curr_date}
                    </Text>
                  </View>
                </View>
                <View style={styles.tableRow}>
                  ...
                  <View style={[styles.tableColGRight, { textAlign: "right" }]}>
                    <Text style={styles.tableCell}>Due on Receipt</Text>
                  </View>
                </View>
                <View style={styles.tableRow}>
                  <View style={[styles.tableColGLeft, { textAlign: "right" }]}>
            ...
            <View style={styles.table}>
              <View style={styles.tableRow}>
                ...
                <View style={styles.tableColRight}>
                  <Text style={[styles.tableCell, { textAlign: "right" }]}>
                    {`${data.invoice.net.toLocaleString()}.00`}
                  </Text>
                </View>
              </View>
              <View style={styles.tableRow}>
                ...
                <View style={[styles.tableColRight, { textAlign: "right" }]}>
                  <Text
                    style={styles.tableCell}
                  >{`PKR ${data.invoice.received.toLocaleString()}.00`}</Text>
                </View>
              </View>

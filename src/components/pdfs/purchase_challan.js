...
function PurchaseChallan({ user, ToggleAlert }) {
  // delivery_challan;
  ...
  const fetchData = async () => {
    ...
    await axios
      .get(
        `${process.env.REACT_APP_API_URL}/purchase/invoice/purchase_challan?id=${params.id}`
      )
      .then((response) => {
          ...
          <View style={styles.FlexSection}>
            ...
            <View>
              ...
              <Text style={[styles.ParagraphFont, { marginLeft: "auto" }]}>
                Purchase Invoice# PI-{data.invoice}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.table}>
            ...
            <View style={styles.tableRow}>
              ...
              <View style={styles.tableColR}>
                ...
                >{`${data.amount.toLocaleString()}.00`}</Text>
              </View>
              {/* <View style={styles.tableCol}>
                <Text style={styles.tableCell}>{`PKR ${(
                  data.net - data.amount
                ).toLocaleString()}`}</Text>
              </View> */}
            </View>
          </View>
            ...
            <View style={styles.table}>
              ...
              <View style={styles.tableRow}>
                ...
                <View style={[styles.tableColRight, { textAlign: "right" }]}>
                  <Text
                    style={styles.tableCell}
                  >{`- ${data.received.toLocaleString()}.00`}</Text>
                </View>
              </View>
              <View style={[styles.tableRow, { backgroundColor: "#f6f6f6" }]}>
                ...
                <View style={[styles.tableColRight, { textAlign: "right" }]}>
                  <Text style={[styles.tableCell, { fontFamily: "Lato Bold" }]}>
                    {`PKR ${(data.net - data.received).toLocaleString()}.00`}
                  </Text>
                </View>
              </View>
            </View>

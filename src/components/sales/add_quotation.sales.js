...
const Add_SalesQuotaion = ({ ToggleAlert }) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${process.env.REACT_APP_API_URL}/qoutation?id=${user_id}`)
      .then((response) => {
  ...
  const handleChange = (e) => {
    ...
    if (e.target.name == "product_id") {
      if (product_value <= 0) {
        ...
        set_product_id([myArray[0], myArray[2]]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = `${process.env.REACT_APP_API_URL}/qoutation/add?data=${add_value_put}`;
      ...
      setTimeout(() => {
        ToggleAlert("Success", "Sales Qoutation Added Successfully");
      }, 1000);
                  ...
                  {/* <div className="col-md-6 mb-3">
                    <div className="custom-control custom-switch">
                      ...
                      <label
                        ...
                        for="customSwitch1"
                      >
                        With Reference and Additional Information
                      </label>
                    </div>
                  </div> */}
                </div>
                ...
                >
                  <div className="form-row">
                    <div className="col-12 float-left">
                      ...
                      <button
                        type="button"
                        class="btn btn-primary mb-2 px-md-4 p-2"
                        data-toggle="modal"
                      ...
                      <button
                        type="button"
                        class="btn btn-success mb-2 px-md-4 p-2"
                        style={{
                          float: "right",
...
export default Add_SalesQuotaion;

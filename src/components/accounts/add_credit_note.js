        ...
        <div className="main-card">
          <div className="px-md-4 pt-md-4 px-1 pt-1">
            <div className="d-flex justify-content-between flex-md-row flex-column my-2 border-bottom py-3">
              <h4 className="mb-md-0 text-center text-md-left">Credit Note</h4>
              ...
              <form>
                <div className="form-group row">
                  <label
                    ...
                    className="col-sm-4 col-form-label text-muted h6"
                  >
                    Total Amount(Rs)
                  </label>
...
export default Add_Credit_Note;
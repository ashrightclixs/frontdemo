            ...
            <div className="main-card">
                 <div className="px-md-4 pt-md-4 px-1 pt-1">
                    <div className="d-flex justify-content-between flex-md-row flex-column my-2 border-bottom py-3">
                        <h4 className="mb-md-0 text-center text-md-left">Other Payments</h4>
                        <Link to="/accounts/add_other_payment">
                            <button className="btn btn-md btn-success p-1 p-md-3 ml-md-2 my-2 my-md-0">+ Add Other Payments</button>
                        </Link>
                    </div>

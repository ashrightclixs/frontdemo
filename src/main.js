...
import QoutationChallan from "./components/pdfs/qoutation.pdf";


import Admin_Dashboard from "./components/Admin/AdminSales";
import Error_User from "./components/error/erroruser";



function Main() {
  const { user , ip_address} = useContext(AuthContext);
  ...
  function handleLogout(){
    ...
    axios.get(`${process.env.REACT_APP_API_URL}/user/logout/update?id=${user._id}&data=${ip_address}`)
    .then((response) => {
    ...
    user.isadmin && user.status ?
      <div className="wrapper d-flex align-items-stretch">
        ...
        <div id="content">
          ...
          <Routes>
            <Route path="/dashboard" element={<Admin_Dashboard />}></Route>
      ...
      user.status ?
        <div className="wrapper d-flex align-items-stretch">
          ...
          ></Route> */}
              ...
              ></Route>
                ...
                element={
                  <QoutationChallan user={user} ToggleAlert={HandleToggleBtn} />
                }
              ></Route>
              <Route
        ...
        <div className="wrapper d-flex align-items-stretch">
          ...
          <div id="content">
            ...
            <Routes>
              <Route path="/dashboard" exact element={<Error_User />}></Route>
              <Route
                path="/sales/quotation"
                element={<Error_User ToggleAlert={HandleToggleBtn} />}
              ></Route>
              <Route
                path="/sales/customer"
                element={<Error_User ToggleAlert={HandleToggleBtn} />}
              ...
              <Route
                path="/sales/customer/pdf/:id"
                element={<Error_User ToggleAlert={HandleToggleBtn} user={user} />}
              ></Route>
              <Route
                path="/statements/trail_balance"
                element={<Error_User ToggleAlert={HandleToggleBtn} />}
              ...
              <Route
                path="/profile"
                element={
                  <Error_User ToggleAlert={HandleToggleBtn} />
                }
              ></Route>
              <Route
                path="/sales/delivery/delivery_challan/:id"
                element={
                  <Error_User user={user} ToggleAlert={HandleToggleBtn} />
                }
              ></Route>
              <Route
                path="/sales/invoice/:id"
              ...
              <Route
                path="/inventory/stock_warehouse/:id"
                element={<Error_User user={user} ToggleAlert={HandleToggleBtn} />}
              ></Route>
              {/* PurchaseChallanWarehousePdf */}
              <Route
                path="/billing"
              ...
              ></Route>
              <Route path="/" element={<Error_User replace to="/dashboard" />} />
            </Routes>
            <Alert
              alert={alert}
              Progress={Progress}
